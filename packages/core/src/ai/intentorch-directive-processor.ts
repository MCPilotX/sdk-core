...
export class IntentorchDirectiveProcessor {
   ...
   */
  private findAIAnalysisIntentIndex(intents: AtomicIntent[], _directivePosition: number): number {
   ...
   */
  private findContextIntentId(intents: AtomicIntent[], _directivePosition: number): string | undefined {
