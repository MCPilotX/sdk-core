  ...
  describe('static methods', () => {
    ...
    describe('getProviderConfig', () => {
      it('should return correct config for OpenAI', () => {
        const config = (DaemonServer as any).getProviderConfig('openai', 'test-api-key', 'gpt-4');
      ...
      it('should return correct config for DeepSeek', () => {
        const config = (DaemonServer as any).getProviderConfig('deepseek', 'test-api-key', 'deepseek-chat');
      ...
      it('should return correct config for Anthropic', () => {
        const config = (DaemonServer as any).getProviderConfig('anthropic', 'test-api-key', 'claude-3-opus');
      ...
      it('should return correct config for Cohere', () => {
        const config = (DaemonServer as any).getProviderConfig('cohere', 'test-api-key', 'command');
      ...
      it('should throw error for unsupported provider', () => {
        expect(() => {
          (DaemonServer as any).getProviderConfig('unsupported', 'test-api-key');
    ...
    describe('createTestRequest', () => {
      it('should create correct test request for OpenAI', () => {
        const request = (DaemonServer as any).createTestRequest('openai', 'gpt-4');
      ...
      it('should create correct test request for Anthropic', () => {
        const request = (DaemonServer as any).createTestRequest('anthropic', 'claude-3-opus');
      ...
      it('should create correct test request for Cohere', () => {
        const request = (DaemonServer as any).createTestRequest('cohere', 'command');
      ...
      it('should throw error for unsupported provider', () => {
        expect(() => {
          (DaemonServer as any).createTestRequest('unsupported');
