...
import { Tool, ToolCall, ToolResult } from '../../../src/mcp/types';

// Helper function to create a valid ToolResult
const createSuccessResult = (text: string): ToolResult => ({
...
describe('ToolRegistry', () => {
  ...
  describe('工具注册', () => {
    it('应该注册单个工具', () => {
      ...
      const executor = async (args: any) => createSuccessResult('Success');
    ...
    it('应该批量注册工具', () => {
      ...
      const executorFactory = (toolName: string) => async (args: any) => ({
