...
describe('ProcessManager Comprehensive Tests', () => {
    ...
    beforeEach(() => {
        ...
        NodeAdapter.mockImplementation(() => mockNodeAdapter);
        PythonAdapter.mockImplementation(() => mockPythonAdapter);
        DockerAdapter.mockImplementation(() => mockDockerAdapter);
    ...
    describe('constructor and loadFromConfig', () => {
        ...
        it('should load instances from config file when it exists', () => {
            ...
            expect(pm.instances.size).toBe(2);
            const instance1 = pm.instances.get('test-service-1');
            expect(instance1).toBeDefined();
            expect(instance1.name).toBe('test-service-1');
            expect(instance1.runtime).toBe('node');
            expect(instance1.status).toBe('stopped');
            const instance2 = pm.instances.get('test-service-2');
        ...
        it('should handle malformed config file', () => {
            ...
            expect(processManager.instances.size).toBe(0);
        });
    ...
    describe('startService', () => {
        ...
        it('should start Node.js service successfully', async () => {
            ...
            processManager.instances.set('node-service', instance);
        ...
        it('should start Python service successfully', async () => {
            ...
            processManager.instances.set('python-service', instance);
        ...
        it('should start Docker service successfully', async () => {
            ...
            processManager.instances.set('docker-service', instance);
        ...
        it('should handle service already running', async () => {
            ...
            processManager.instances.set('running-service', instance);
        ...
        it('should handle service in error state', async () => {
            ...
            processManager.instances.set('error-service', instance);
        ...
        it('should handle adapter setup failure', async () => {
            ...
            processManager.instances.set('failing-service', instance);
            // Mock start to fail
        ...
        it('should handle service without adapter', async () => {
            ...
            processManager.instances.set('no-adapter-service', instance);
    ...
    describe('discoverTools', () => {
        ...
        it('should handle service not running', async () => {
            ...
            processManager.instances.set('stopped-service', instance);
            await expect(processManager.discoverTools('stopped-service')).rejects.toThrow('Service stopped-service is not running');
        });
    ...
    describe('callService', () => {
        ...
        it('should throw error when service does not exist', async () => {
            await expect(processManager.callService('non-existent-service', 'testMethod')).rejects.toThrow('Service non-existent-service not found');
        });
        it('should start service when not running and call method', async () => {
            ...
            mockNodeAdapter.call.mockImplementation((method, params) => {
        ...
        it('should handle adapter call error', async () => {
            ...
            await expect(processManager.callService('running-service', 'testTool')).rejects.toThrow('Adapter call failed');
        });
        it('should handle service without adapter after start', async () => {
            ...
            NodeAdapter.mockImplementation(() => failingAdapter);
            await expect(processManager.callService('stopped-service', 'testMethod')).rejects.toThrow('Failed to start adapter');
    ...
    describe('EventEmitter functionality', () => {
        ...
        it('should emit service-started event when service starts successfully', async () => {
            ...
            processManager.instances.set('test-service', instance);
    ...
    describe('instance management', () => {
        ...
        it('should allow adding new service instances', () => {
            ...
            processManager.instances.set('test-service', instance);
            const retrievedInstance = processManager.instances.get('test-service');
        ...
        it('should handle multiple instances independently', async () => {
            ...
            processManager.instances.set('service1', instance1);
            processManager.instances.set('service2', instance2);
            // Start service1
...
//# sourceMappingURL=pm-comprehensive.test.js.map