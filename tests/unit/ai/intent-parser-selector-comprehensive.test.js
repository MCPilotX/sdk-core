...
describe('IntentParserSelector Comprehensive Tests', () => {
    ...
    beforeEach(() => {
        ...
        mockFactory.getParserCapabilities.mockImplementation((type) => {
            switch (type) {
                case 'rule':
                    return {
...
//# sourceMappingURL=intent-parser-selector-comprehensive.test.js.map