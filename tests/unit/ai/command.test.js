...
describe('SimpleAICommand', () => {
    ...
    beforeEach(() => {
        ...
        AIConfigManager.mockImplementation(() => mockConfigManager);
    ...
    describe('constructor', () => {
        ...
        it('should configure AI when provider is not "none"', async () => {
            ...
            const config = { provider: 'openai', apiKey: 'test-key', model: 'gpt-4' };
    ...
    describe('handleCommand', () => {
        ...
        it('should handle generateText command', async () => {
            ...
            const mockResult = { type: 'suggestions', message: 'Test response' };
