...
describe('HybridAIParser Coverage Tests', () => {
    ...
    describe('edge cases', () => {
        ...
        it('should handle null or undefined context', async () => {
            ...
            const result2 = await hybridParser.parse('read file /test', null);
        ...
        it('should handle AI service returning null or undefined intent', async () => {
            ...
            mockAIService.analyzeIntent.mockResolvedValue(null);
...
//# sourceMappingURL=hybrid-ai-parser-coverage.test.js.map