...
describe('IntentParserFactory Comprehensive Tests', () => {
    ...
    beforeEach(() => {
        ...
        RuleBasedParser.mockImplementation(() => {
        ...
        HybridAIParser.mockImplementation(() => {
    ...
    describe('Basic functionality', () => {
        ...
        it('should throw error for unknown parser type', () => {
            expect(() => factory.createParser('unknown')).toThrow('Unknown parser type: unknown');
        });
    });
    ...
    describe('Parser capabilities', () => {
        ...
        it('should throw error for unknown parser type capabilities', () => {
            expect(() => factory.getParserCapabilities('unknown')).toThrow('Unknown parser type: unknown');
        });
    });
    describe('Configuration', () => {
        it('should update configuration', () => {
            const newConfig = { defaultParserType: 'rule' };
    ...
    describe('Error handling', () => {
        ...
        it('should handle invalid parser type in createParser', () => {
            expect(() => factory.createParser('invalid')).toThrow('Unknown parser type: invalid');
        });
        it('should handle invalid parser type in getParser', () => {
            expect(() => factory.getParser('invalid')).toThrow('Unknown parser type: invalid');
        });
        it('should handle invalid parser type in getParserCapabilities', () => {
            expect(() => factory.getParserCapabilities('invalid')).toThrow('Unknown parser type: invalid');
        });
    });
    describe('Edge cases', () => {
        it('should handle case-insensitive parser type', () => {
            expect(() => factory.createParser('RULE')).toThrow('Unknown parser type: RULE');
        });
        it('should handle whitespace in parser type', () => {
            expect(() => factory.createParser(' rule ')).toThrow('Unknown parser type:  rule ');
        });
        it('should handle empty string parser type', () => {
            expect(() => factory.createParser('')).toThrow('Unknown parser type: ');
        });
        it('should handle null parser type', () => {
            expect(() => factory.createParser(null)).toThrow('Unknown parser type: null');
        });
        it('should handle undefined parser type', () => {
            expect(() => factory.createParser(undefined)).toThrow('Unknown parser type: undefined');
        });
    });
...
//# sourceMappingURL=intent-parser-factory-comprehensive.test.js.map