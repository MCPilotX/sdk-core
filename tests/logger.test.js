...
describe('Logger', () => {
    ...
    describe('Specialized logging methods', () => {
        ...
        it('should log requests correctly', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Received command: test-command'));
        });
        it('should log service events correctly', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Service my-service: started'));
        });
        it('should log AI queries correctly', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('AI Query: "What is the meaning of life?"'));
        });
        it('should log config updates with masked API keys', () => {
            ...
            expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Configuration updated: ai'));
    ...
    describe('Warn logging', () => {
        ...
        it('should log warn messages when log level is WARN', () => {
            ...
            const writeToFileSpy = jest.spyOn(testLogger, 'writeToFile').mockImplementation(() => { });
