...
import type { Tool, ToolCall, ToolResult } from '../src/mcp/types';
...
describe('MCP Module Coverage Tests', () => {
  describe('ParameterMapper', () => {
    ...
    it('should validate and normalize parameters', () => {
      ...
      const toolSchema = {
        type: 'object' as const,
        properties: {
          requiredParam: { type: 'string' as const },
          optionalParam: { type: 'number' as const },
        },
  ...
  describe('ToolRegistry', () => {
    ...
    it('should register and retrieve tools', () => {
      ...
      const executor = async (args: any): Promise<ToolResult> => ({
