...
const createMockChildProcess = () => {
    const mock = {
        on: jest.fn((event, listener) => mock),
        kill: jest.fn(() => true),
        stdin: null,
        stdout: null,
        stderr: null,
...
describe('ProcessManager', () => {
    ...
    describe('startService', () => {
        ...
        it('should start a service successfully', async () => {
            ...
            expect(mockSpawn).toHaveBeenCalledWith('/path/to/service.js', ['--port', '3000'], {
        ...
        it('should handle absolute paths correctly', async () => {
            ...
            expect(mockSpawn).toHaveBeenCalledWith('/absolute/path/to/service.js', [], expect.any(Object));
        });
        it('should handle process exit event', async () => {
            ...
            // Trigger exit
            exitHandler(0);
            expect(mockConsoleLog).toHaveBeenCalledWith('Service test-service exited with code 0');
        });
        it('should handle process error event', async () => {
            ...
            expect(mockConsoleError).toHaveBeenCalledWith('Service test-service error:', 'Process failed');
        });
    });
...
//# sourceMappingURL=daemon-process.test.js.map