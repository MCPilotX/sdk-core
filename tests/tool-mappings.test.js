...
import { DEFAULT_TOOL_MAPPINGS, ToolMappingManager, toolMappingManager } from '../src/ai/tool-mappings';
...
describe('DEFAULT_TOOL_MAPPINGS', () => {
    ...
    it('should have correct file system mappings', () => {
        const listFilesMapping = DEFAULT_TOOL_MAPPINGS.find(m => m.intentAction === 'list' && m.intentTarget === 'files');
    ...
    it('should have correct network mappings', () => {
        const pingMapping = DEFAULT_TOOL_MAPPINGS.find(m => m.intentAction === 'ping' && m.intentTarget === 'network');
...
describe('ToolMappingManager', () => {
    ...
    describe('Edge Cases and Error Handling', () => {
        ...
        it('should handle duplicate custom mappings', () => {
            ...
            const allMappings = manager.getAllMappings();
            const duplicates = allMappings.filter(m => m.intentAction === 'duplicate' && m.intentTarget === 'action');
...
describe('Integration Tests', () => {
    it('should work with real default mappings', () => {
        ...
        DEFAULT_TOOL_MAPPINGS.forEach(defaultMapping => {
            const found = toolMappingManager.findMapping(defaultMapping.intentAction, defaultMapping.intentTarget);
            expect(found).toBeDefined();
            expect(found?.primaryTool).toBe(defaultMapping.primaryTool);
        });
    });
    it('should handle complex parameter mapping scenarios', () => {
        const readFileMapping = DEFAULT_TOOL_MAPPINGS.find(m => m.intentAction === 'read' && m.intentTarget === 'file');
...
//# sourceMappingURL=tool-mappings.test.js.map