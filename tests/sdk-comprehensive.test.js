import { IntentOrchSDK, MCPilotSDK } from '../src/sdk';
...
describe('IntentOrchSDK - Comprehensive Tests', () => {
    ...
    beforeEach(() => {
        ...
        mockAI = {
            ...
            ask: jest.fn().mockImplementation((query) => {
        ...
        CloudIntentEngine.mockImplementation(() => mockCloudIntentEngine);
        // Mock discoverLocalMCPServers
        discoverLocalMCPServers.mockResolvedValue([]);
        // Create SDK instance
    ...
    describe('stopService() - Enhanced Error Handling', () => {
        ...
        it('should handle error when adapter.stop() fails', async () => {
            ...
            const mockCreateAdapter = jest.spyOn(RuntimeAdapterRegistry, 'createAdapter').mockReturnValue(mockAdapter);
        ...
        it('should handle String() conversion in error message', async () => {
            ...
            jest.spyOn(RuntimeAdapterRegistry, 'createAdapter').mockReturnValue(mockAdapter);
            await expect(sdk.stopService('test-service'))
    ...
    describe('discoverMCPServers()', () => {
        ...
        it('should discover MCP servers successfully', async () => {
            const mockServers = [
                { name: 'server1', transport: { type: 'stdio', command: 'python' } },
                { name: 'server2', transport: { type: 'http', url: 'http://localhost:8080' } },
            ];
            discoverLocalMCPServers.mockResolvedValueOnce(mockServers);
        ...
        it('should handle discovery errors', async () => {
            discoverLocalMCPServers.mockRejectedValueOnce(new Error('Discovery failed'));
    ...
    describe('connectMCPServer() and disconnectMCPServer()', () => {
        ...
        it('should disconnect from MCP server successfully', async () => {
            ...
            MCPClient.mockImplementationOnce(() => mockClientInstance);
        ...
        it('should handle disconnect errors', async () => {
            ...
            sdk.mcpClients.set('test-server', mockClientInstance);
    ...
    describe('connectAllFromConfig() and disconnectAll()', () => {
        ...
        it('should handle partial failures in batch connection', async () => {
            const config = {
                servers: [
                    ...
                    {
                        name: 'server2',
                        transport: { type: 'stdio', command: 'invalid' },
                    },
                ],
            };
        ...
        it('should disconnect all servers successfully', async () => {
            ...
            sdk.mcpClients.set('server1', mockClient1);
            sdk.mcpClients.set('server2', mockClient2);
    ...
    describe('getMCPServerStatus()', () => {
        ...
        it('should return server status when server exists', () => {
            ...
            sdk.mcpClients.set('test-server', mockClient);
    ...
    describe('Error Recovery', () => {
        ...
        it('should handle partial MCP server failures gracefully', async () => {
            ...
            const config = {
                servers: [
                    { name: 'server1', transport: { type: 'stdio', command: 'python' } },
                    { name: 'server2', transport: { type: 'stdio', command: 'invalid' } },
                    { name: 'server3', transport: { type: 'stdio', command: 'python' } },
                ],
            };
            let callCount = 0;
            const mockConnect = jest.spyOn(sdk, 'connectMCPServer').mockImplementation(async (config, name) => {
...
//# sourceMappingURL=sdk-comprehensive.test.js.map