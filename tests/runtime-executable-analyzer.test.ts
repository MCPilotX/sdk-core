...
describe('ExecutableAnalyzer', () => {
  ...
  describe('analyze', () => {
    ...
    it('should return null when file is not executable', () => {
      ...
      jest.spyOn(ExecutableAnalyzer as any, 'isExecutable').mockReturnValue(false);
    ...
    it('should use file command analysis when available', () => {
      mockExistsSync.mockReturnValue(true);
      mockStatSync.mockReturnValue({ isFile: () => true });
      jest.spyOn(ExecutableAnalyzer as any, 'isExecutable').mockReturnValue(true);
    ...
    it('should use shebang analysis for script files', () => {
      ...
      mockReadFileSync.mockImplementation((filePath: string, options: any) => {
        if (options?.flag === 'r') {
  ...
  describe('analyzeWithFileCommand', () => {
    it('should detect ELF binary', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithFileCommand('/path/to/binary');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.9);
    ...
    it('should detect Windows PE binary', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithFileCommand('/path/to/binary.exe');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.9);
    ...
    it('should detect Node.js script', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithFileCommand('/path/to/script.js');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('node');
      expect(result?.confidence).toBe(0.95);
    ...
    it('should detect Python script', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithFileCommand('/path/to/script.py');
      expect(result).not.toBeNull();
    ...
    it('should detect Bash script', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithFileCommand('/path/to/script.sh');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.85);
    ...
    it('should return null for unrecognized file type', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithFileCommand('/path/to/data.bin');
      expect(result).toBeNull();
    });
    ...
    it('should handle file command errors', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithFileCommand('/path/to/file');
      expect(result).toBeNull();
    });
  });
  ...
  describe('analyzeWithMagicNumbers', () => {
    it('should detect ELF file', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithMagicNumbers('/path/to/elf');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.85);
      expect(result?.details.result).toBe('ELF executable');
    ...
    it('should detect Mach-O file (64-bit)', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithMagicNumbers('/path/to/macho64');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.85);
      expect(result?.details.result).toBe('Mach-O executable');
    ...
    it('should detect Mach-O file (32-bit)', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithMagicNumbers('/path/to/macho32');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.85);
      expect(result?.details.result).toBe('Mach-O executable');
    ...
    it('should detect Windows PE file', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithMagicNumbers('/path/to/pe.exe');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.85);
      expect(result?.details.result).toBe('Windows PE executable');
    ...
    it('should detect Java class file', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithMagicNumbers('/path/to/Test.class');
      expect(result).not.toBeNull();
    ...
    it('should return null for unknown magic numbers', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithMagicNumbers('/path/to/unknown');
      expect(result).toBeNull();
    });
    ...
    it('should handle read errors', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeWithMagicNumbers('/path/to/unreadable');
      expect(result).toBeNull();
    });
  });
  ...
  describe('analyzeShebang', () => {
    it('should detect Node.js shebang', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeShebang('/path/to/script.js');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('node');
      expect(result?.confidence).toBe(0.9);
    ...
    it('should detect Python shebang', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeShebang('/path/to/script.py');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('python');
      expect(result?.confidence).toBe(0.9);
    ...
    it('should detect Bash shebang', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeShebang('/path/to/script.sh');
      expect(result).not.toBeNull();
      expect(result?.type).toBe('binary');
      expect(result?.confidence).toBe(0.85);
    ...
    it('should handle read errors', () => {
      ...
      const result = (ExecutableAnalyzer as any).analyzeShebang('/path/to/unreadable');
      expect(result).toBeNull();
    });
  });
  ...
  describe('isExecutable', () => {
    ...
    it('should return true for Unix executable files', () => {
      ...
      const result = (ExecutableAnalyzer as any).isExecutable('/path/to/script');
    ...
    it('should return false for Unix non-executable files', () => {
      ...
      const result = (ExecutableAnalyzer as any).isExecutable('/path/to/file.txt');
    ...
    it('should return true for Windows executable extensions', () => {
      ...
      const result = (ExecutableAnalyzer as any).isExecutable('/path/to/program.exe');
      expect(result).toBe(true);
    });
    ...
    it('should return true for files with shebang', () => {
      ...
      const result = (ExecutableAnalyzer as any).isExecutable('/path/to/script.sh');
      expect(result).toBe(true);
    });
    ...
    it('should handle stat errors', () => {
      ...
      const result = (ExecutableAnalyzer as any).isExecutable('/path/to/inaccessible');
      expect(result).toBe(false);
    });
  });
  ...
  describe('findExecutables', () => {
    ...
    it('should find executable files', () => {
      ...
      jest.spyOn(ExecutableAnalyzer as any, 'isExecutable').mockImplementation((filePath: string) => {
  ...
  describe('analyzeDirectory', () => {
    it('should analyze all executable files in directory', () => {
      ...
      jest.spyOn(ExecutableAnalyzer, 'analyze').mockImplementation((filePath: string) => {
