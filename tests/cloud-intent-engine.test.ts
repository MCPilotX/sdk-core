  ...
  describe('utility methods', () => {
    describe('buildDependencyGraph', () => {
      it('should build dependency graph', () => {
        ...
        const graph = (engine as any).buildDependencyGraph(intents, edges);
    ...
    describe('topologicalSort', () => {
      it('should sort nodes in dependency order', () => {
        ...
        const sorted = (engine as any).topologicalSort(graph);
    ...
    describe('resolveParameters', () => {
      it('should resolve parameters with variable substitution', () => {
        ...
        const resolved = (engine as any).resolveParameters(params, context);
