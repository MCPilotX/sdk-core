import { MCPilotSDK, IntentOrchSDK, mcpilot } from '../src/sdk';
...
describe('IntentOrchSDK (formerly MCPilotSDK)', () => {
    ...
    describe('getConfig()', () => {
        ...
        it('should get configuration', () => {
            ...
            jest.spyOn(ConfigManager, 'getGlobalConfig').mockReturnValue(mockConfig);
    ...
    describe('generateText()', () => {
        ...
        it('should throw error when AI is not configured', async () => {
            ...
            const mockAIInstance = AI.mock.results[0].value;
    ...
    describe('MCP Functionality', () => {
        ...
        describe('initMCP()', () => {
            it('should initialize MCP functionality', async () => {
                ...
                const mockConnectMCPServer = jest.spyOn(sdk, 'connectMCPServer').mockResolvedValue({});
                await sdk.initMCP();
