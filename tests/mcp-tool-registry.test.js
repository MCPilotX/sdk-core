...
describe('ToolRegistry', () => {
    ...
    describe('Tool Registration', () => {
        ...
        test('should register multiple tools at once', () => {
            ...
            const executorFactory = jest.fn().mockImplementation((toolName) => {
                return jest.fn();
            });
            // Act
    ...
    describe('Tool Search', () => {
        beforeEach(() => {
            ...
            tools.forEach((tool, index) => {
                toolRegistry.registerTool(createSimpleTool(tool.name, tool.description), jest.fn(), tool.server, `tool-${index}`);
            });
        });
    ...
    describe('Tool Statistics', () => {
        test('should get tool statistics', () => {
            ...
            tools.forEach((tool, index) => {
                toolRegistry.registerTool(createSimpleTool(tool.name, 'Test tool'), jest.fn(), tool.server, `tool-${index}`);
            });
            // Act
        ...
        test('should get tool statistics with usage data', () => {
            ...
            const privateToolRegistry = toolRegistry;
...
//# sourceMappingURL=mcp-tool-registry.test.js.map